...
from numpyPablo import barycentricCoords, cross_product, inverse_matrix, matrixMultiplier, subtract_vector, vector_normalize
from obj import Obj
...
class Renderer(object):
    ...
    def glModelMatrix(self, translate = (0,0,0), rotate=(0,0,0), scale = (1,1,1)):
        ...
        transformation_matrix =  matrixMultiplier((matrixMultiplier(translationMat, rotationMat)), scaleMat)
    ...
    def glRotationMatrix(self, pitch = 0, yaw = 0, roll = 0):
        ...
        return matrixMultiplier(matrixMultiplier(pitchMat, yawMat), rollMat)
